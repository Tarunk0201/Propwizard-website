...
//           <p className="text-3xl text-gray-600 font-serif leading-relaxed italic">
...
//           </div>
//           <div className="mt-6">
//             <button className="bg-[#333] text-white px-8 py-3 rounded-sm text-sm font-semibold hover:bg-black transition-colors">
//               Explore Our Work
//             </button>
//           </div>
//         </div>
...
//               <div key={idx} className="bg-gray-50 p-5 rounded-sm">
...
//               ))}
//             </div>
//             <button className="bg-black text-white rounded-full flex items-center justify-between px-4 py-2 text-sm font-medium group self-start">
//               <span>See Live Demo</span>
//               <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center ml-4 transform transition-transform group-hover:rotate-45">
//                 <svg
...
//               <div key={idx} className="bg-gray-100 p-5 rounded-sm">
//                 <h4 className="font-serif text-base font-medium text-gray-800">
//                   {feature.title}
//                 </h4>
//                 <p className="text-xs text-gray-500 mt-1">{feature.desc}</p>
...
//               ))}
//             </div>
//             <div className="bg-gray-100 p-5 rounded-sm mt-4">
//               <p className="text-2xl font-serif text-gray-800">
...
//           {/* Main Structural Layout Block Placeholder Box Component */}
...
//             <div className="w-14 h-14 bg-white text-black rounded-full shadow-md flex items-center justify-center cursor-pointer transition transform group-hover:scale-110 group-hover:bg-[#0047B3] group-hover:text-white">
//               <svg
//                 fill="currentColor"
//                 viewBox="0 0 24 24"
...
//           {/* Description Action Callout Frame */}
...
//               className="bg-[#0047B3] text-white text-xs font-mono tracking-widest uppercase px-6 py-3 rounded-sm flex items-center gap-3 shadow-md"
//             >
